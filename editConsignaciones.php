...
//$data = "SELECT * FROM orders WHERE tipo_orden = 1 AND id_order = $idOrder";
...
$data = "SELECT orders.id_order, orders.fecha_add, orders.hora_add, orders.client_id, orders.total_neto, orders.descuento, orders.total, orders.metodo, orders.totalProducto, orders.tipo_orden, orders.monto, orders.saldo, orders.estado, orders.fecha_liqui, orders.user_add_id, client.id_client, client.nombre_cte, client.categoria, client.comentario 
		 ...
		 WHERE orders.tipo_orden = 1 AND orders.id_order = $idOrder";
$resData = $connect->query($data);
...
<div class="panel panel-default">
	<div class="panel-heading">
			<i class="glyphicon glyphicon-pencil"></i> Orden Consignación <strong class="text-danger">Folio:  <?php echo $rowData[0];?></strong>
		...
		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderFormVentas">
			...
			<table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT orders_detalle.order_detalle_id, orders_detalle.order_id, orders_detalle.product_id, orders_detalle.cantidad, 
			  								orders_detalle.precio, orders_detalle.total FROM orders_detalle WHERE orders_detalle.order_id = {$idOrder}";
			  	    ...
			  	    ?>
				  		...
				  		<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
							...
							<td style="display:none">
								<input type="text" name="statusProd2[]" id="statusProd2<?php echo $x; ?>" autocomplete="off"  class="form-control" style="display:none"  />	
							</td>
			...
			<div class="col-md-6">
				<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="totalAmount" name="totalAmount" disabled="true" value="<?php echo $rowData[4] ?>"/>
				      <input type="hidden" class="form-control" id="totalAmountValue" name="totalAmountValue" value="<?php echo $rowData[4] ?>" />
				    </div>
				</div> <!--/form-group-->
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" value="<?php echo $rowData[5] ?>" />
				    </div>
				</div> <!--/form-group-->	
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grandTotal" name="grandTotal" disabled="true" value="<?php echo $rowData[6] ?>" />
				      <input type="hidden" class="form-control" id="grandTotalValue" name="grandTotalValue" value="<?php echo $rowData[6] ?>" />
				    </div>
				</div> <!--/form-group-->	
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grandTotalProductos2"   name="grandTotalProductos2" value="<?php echo $rowData[8] ?>" disabled="true" />
				      <input type="hidden" class="form-control" id="grandTotalProductos" name="grandTotalProductos"  value="<?php echo $rowData[8] ?>" />
				    </div>
				</div> <!--/form-group-->	
			...
			<div class="col-md-6">
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" value="<?php echo $rowData[10] ?>"/>
				    </div>
				</div> <!--/form-group-->	
				...
				<div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="due" name="due" disabled="true" value="<?php echo $rowData[11] ?>" />
				      <input type="hidden" class="form-control" id="dueValue" name="dueValue" value="<?php echo $rowData[11] ?>" />
				    </div>
				</div> <!--/form-group-->	
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" value="<?php echo $rowData[13] ?>" />
			    </div>
			  </div> <!--/form-group-->
...
<script src="custom/js/orderVenta.js"></script>
